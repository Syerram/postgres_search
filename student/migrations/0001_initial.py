...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'student_studentcourse', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'student', ['StudentCourse'])

        # Adding unique constraint on 'StudentCourse', fields ['student', 'course']
        db.create_unique(u'student_studentcourse', ['student_id', 'course_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'StudentCourse', fields ['student', 'course']
        db.delete_unique(u'student_studentcourse', ['student_id', 'course_id'])

        # Deleting model 'Student'
        db.delete_table(u'student_student')

        # Deleting model 'StudentCourse'
        db.delete_table(u'student_studentcourse')
    ...
    models = {
        ...
        u'student.studentcourse': {
            'Meta': {'unique_together': "(('student', 'course'),)", 'object_name': 'StudentCourse'},
